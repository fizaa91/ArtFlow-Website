...
// Import images
import wp1 from '../../assets/cp1.jpg';
import wp2 from '../../assets/cp2.jpg';
import wp3 from '../../assets/cp3.jpg';
import wp4 from '../../assets/cp4.jpg';
import wp5 from '../../assets/cp5.jpg';
import wp6 from '../../assets/cp6.jpg';
import wp7 from '../../assets/cp7.jpg';
import wp8 from '../../assets/cp8.jpg';
import wp9 from '../../assets/cp9.jpg';
...
const Portraits = () => {
  ...
  return (
    <div className="portraits-gallery" id="portraits">
      <h1 className="gallery-heading">Portrait Photography</h1>
      <div className="card-grid">
        {images.map((image) => (
          <div className="card" key={image.id} onClick={() => openImage(image)}>
            <img src={image.src} alt="Portrait" className="card-image" />
